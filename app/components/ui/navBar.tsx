...
export default function NavBar() {
  return (
    <Disclosure
      as="nav"
      className="z-50 relative bg-gray-800 dark:bg-gray-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10"
    >
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
                <a className="font-cocacola text-white hover:bg-white/5 hover:text-white',
                      'rounded-md px-3 py-2 text-sm font-medium">Coca Cola</a>
            </div>
